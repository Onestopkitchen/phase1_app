...
import 'package:osk_dev_app/view/screens/HealthyCo/healthy_co_diet_preference.dart';
import 'package:osk_dev_app/view/widgets/customClipper.dart';

class HealthyCoGoalScreen extends StatefulWidget {
  static String id = 'healthy_co_goal_screen';
  @override
  _HealthyCoGoalScreenState createState() => _HealthyCoGoalScreenState();
}

class _HealthyCoGoalScreenState extends State<HealthyCoGoalScreen> {
  int _SelectedIndex;
                    ...
                    child: Align(
                      ...
                      child: InkWell(
                        onTap: () => Navigator.pushNamed(
                            context, HealthyCoDietPreference.id),
                        child: Container(
                          height: 40,
                          width: 100,
                          decoration: BoxDecoration(
